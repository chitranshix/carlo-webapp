    ...
    toolbar.innerHTML = `
        <div class="flex flex-wrap items-center gap-3 text-sm">
            ...
            <div class="relative" id="pos-dropdown-container">
                <button id="pos-menu-btn" class="bg-white px-3.5 py-2 rounded-lg border border-[#E1E1E1] text-[#333333] text-xs font-medium flex items-center space-x-3 hover:bg-gray-50 transition cursor-pointer shadow-xs select-none">
            ...
            <div class="relative" id="status-dropdown-container">
                <button id="status-menu-btn" class="bg-white px-3.5 py-2 rounded-lg border border-[#E1E1E1] text-[#333333] text-xs font-medium flex items-center space-x-3 hover:bg-gray-50 transition cursor-pointer shadow-xs select-none">
        ...
        <div class="flex items-center space-x-3 text-xs text-[#767676]">
            ...
            <button id="toggle-sentence-btn" class="flex items-center space-x-1.5 bg-white px-3.5 py-2 rounded-lg border border-[#E1E1E1] hover:bg-gray-50 transition select-none cursor-pointer text-[#333333] font-medium shadow-xs ${!state.showSentence ? 'opacity-50' : ''}">
                <span>
                    <svg class="w-4 h-4 text-[#111111]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                </span>
                <span>Sentences</span>
